var TableDatatablesFixedHeader = function () {
    ...
    var initTable1 = function () {
        ...
        } else if ($('body').hasClass('page-header-menu-fixed')) { // usuario 3 fixed header menu mode
            fixedHeaderOffset = $('.page-header-menu').outerHeight(true);
        } else if ($('body').hasClass('page-header-top-fixed')) { // usuario 3 fixed header top mode
            fixedHeaderOffset = $('.page-header-top').outerHeight(true);
        } else if ($('.page-header').hasClass('navbar-fixed-top')) {
            fixedHeaderOffset = $('.page-header').outerHeight(true);
        } else if ($('body').hasClass('page-header-fixed')) {
            fixedHeaderOffset = 64; // usuario 5 fixed height
        }
